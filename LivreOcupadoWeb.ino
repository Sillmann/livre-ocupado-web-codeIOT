...
void loop() { 
 livre = ThingSpeak.readFloatField(channel, 1); 
 ...
 if 
((varBotaoVerdeApertado==1)and(varBotaoVerdeLiberado==1)and(digitalRea
d(ledVerde)==LOW)){ 
 ...
 if 
((varBotaoVermelhoApertado==1)and(varBotaoVermelhoLiberado==1)and(digi
talRead(ledVermelho)==LOW)){ 
 varBotaoVermelhoApertado=0; 
 varBotaoVermelhoLiberado=0; 
 acenderLedVermelho(); 
 apagarLedVerde(); 
